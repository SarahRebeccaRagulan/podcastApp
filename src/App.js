...
function App() {
  return (
    <div className="App">
      ...
      <section>
        <form action="">
          <label name="startingPoint"
          aria-label="starting point">
            <input type="text" placeholder="Starting Point" name="startingPoint" class="nameInput"/>
          </label>

          <label name="destination"
          aria-label="destination">
            <input type="text" placeholder="Destination" name="destination" class="nameInput"/>
          </label>
